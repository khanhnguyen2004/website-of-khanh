'use client';
import style from '@/app/cart/styles/app.pay.module.css';
const AppPay = () => {
    return (
        <>
            <div className={style["right-cart"]}>
                <div className={style["title-pay"]}>Order Summary</div>
                <div className={style["info-pay"]}>
                    <div className={style["info-pay-child"]}>
                        <div className={style["title-pay"]}>Subtotal</div>
                        <div className={style["number-pay"]}>$565</div>
                    </div>
                    <div className={style["info-pay-child"]}>
                        <div className={style["title-pay"]}>Discount (-20%)</div>
                        <div className={style["number-pay"]}>-$113</div>
                    </div>
                    <div className={style["info-pay-child"]}>
                        <div className={style["title-pay"]}>Delivery Fee</div>
                        <div className={style["number-pay"]}>$15</div>
                    </div>
                    ...
                    <div className={style["info-pay-child"]}>
                        ...
                        <div className={style["number-total"]}>$467</div>
                    </div>
                </div>
                <div className={style["discount"]}>
                    <div className={style["discount-child"]}>
                        <svg xmlns="http://www.w3.org/2000/svg" className={style["icon-discount"]} width="22" height="22"
                        ...
                        <input type="text" className={style["input-discount"]} placeholder="Add promo code" />
                    </div>
                    <button className={style["btn-apply"]}>
                        <div className="">Apply</div>
                    </button>
                </div>
                <button className={style["btn-check-out"]}>
                    <div className={style["text-wrapper-21"]}>Go to Checkout</div>
                    <div className={style["arrow-down-bold"]}>
                        <svg xmlns="http://www.w3.org/2000/svg" className={style["vector-11"]} width="19" height="16"
