                ...
                <div className={style["product-cart"]}>
                    <div className={style["product"]}>
                        <div className={style["img-product"]}>
                            <a href={"#"}>
                                <img className={style["image"]} src="/img/image-8-2.png" />
                            </a>
                        </div>
                        <div className={style["right"]}>
                            <div className={style["info-product"]}>
                                <div className={style["name-product"]}>
                                    <a href={"#"}>Gradient Graphic T-shirt</a>
                                </div>
                                <div className={style["variant"]}>
                                    <p className={style["size"]}>
                                        <span className="">Size: </span> <span className={style["name-size"]}>Large</span>
                                    </p>
                                    <p className={style["color"]}>
                                        <span className="">Color: </span> <span className={style["name-color"]}>White</span>
                                    </p>
                                </div>
                            ...
                            <div className={style["control"]}>
                                ...
                                <div className={style["amount"]}>
                                    ...
                                    <input type="text" className={style["amount-input"]} value={amount} min="0" onChange={(e) => setAmount(Number(e.target.value))} />
                                    <div className={style["control-amount"]}>
                                        <a href={"#"}>
                    ...
                    <div className={style["product"]}>
                        <div className={style["img-product"]}>
                            <a href={"#"}>
                                <img className={style["image"]} src="/img/image-9.png" />
                            </a>
                        </div>
                        <div className={style["right"]}>
                            <div className={style["info-product"]}>
                                <div className={style["name-product"]}>
                                    <a href={"#"}>Ckeckered Shirt</a>
                                </div>
                                <div className={style["variant"]}>
                                    <p className={style["size"]}>
                                        <span className="">Size: </span> <span className={style["name-size"]}>Medium</span>
                                    </p>
                                    <p className={style["color"]}>
                                        <span className="">Color: </span> <span className={style["name-color"]}>Red</span>
                                    </p>
                                </div>
                                <div className={style["price"]}>$180</div>
                            </div>
                            <div className={style["control"]}>
                                <div className={style["delete"]}>
                                    <a href={"#"}>
                                ...
                                <div className={style["amount"]}>
                                    ...
                                    <input type="text" className={style["amount-input"]} value={amount1} min="0" onChange={(e) => setAmount1(Number(e.target.value))} />
                                    <div className={style["control-amount"]}>
                                        <a href={"#"}>
                                            <svg xmlns="http://www.w3.org/2000/svg" className={style["icon-plus"]} width="16"
                                                height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <div className={style["product"]}>
                        <div className={style["img-product"]}>
                            <a href={"#"}>
                                <img className={style["image"]} src="/img/image-8.png" />
                            </a>
                        </div>
                        <div className={style["right"]}>
                            <div className={style["info-product"]}>
                                <div className={style["name-product"]}>
                                    <a href={"#"}>Skinny Fit Jeans</a>
                                </div>
                                <div className={style["variant"]}>
                                    <p className={style["size"]}>
                                        <span className="">Size: </span> <span className={style["name-size"]}>Large</span>
                                    ...
                                    <p className={style["color"]}>
                                        <span className="">Color: </span> <span className={style["name-color"]}>Blue</span>
                                    </p>
                                </div>
                                <div className={style["price"]}>$240</div>
                            </div>
                            <div className={style["control"]}>
                                <div className={style["delete"]}>
                                    <a href={"#"}>
                                ...
                                <div className={style["amount"]}>
                                    ...
                                    <input type="text" className={style["amount-input"]} value={amount2} min="0" onChange={(e) => setAmount2(Number(e.target.value))} />
                                    <div className={style["control-amount"]}>
                                        <a href={"#"}>
                                            <svg xmlns="http://www.w3.org/2000/svg" className={style["icon-plus"]} width="16"
                                                height="16" viewBox="0 0 16 16" fill="none">
