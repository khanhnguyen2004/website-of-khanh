                ...
                <div className={style["form-signup"]}>
                    ...
                    <form action="#" method="POST">
                        ...
                        <div className={style["input-group"]}>
                            ...
                            <input type="text" id="number-phone" name="number-phone" placeholder="Enter your number-phone" required />
                        </div>
                        <div className={style["input-group"]}>
                        ...
                        <div className={style["input-group"]}>
                            ...
                            <div className={style["input-wrapper"]}>
                                <input type={showPassword ? "text" : "password"} id="password" name="password" placeholder="Create a password" required />
                        ...
                        <div className={style["input-group"]}>
                            ...
                            <div className={style["input-wrapper"]}>
                                <input type={showConfirm ? "text" : "password"} id="password" name="password" placeholder="Confirm your password" required />
